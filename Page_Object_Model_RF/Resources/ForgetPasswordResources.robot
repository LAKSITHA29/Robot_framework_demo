...
*** Variables ***
${frogot_page_title}    css:.orangehrm-forgot-password-title
...
${login_page_title}    xpath://div[@class='orangehrm-login-slot']/h5

*** Keywords ***
Verify Forgot Your Password Page Opens
    Element Text Should Be    ${frogot_page_title}    Reset Password
